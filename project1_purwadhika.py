# -*- coding: utf-8 -*-
"""Project1_Purwadhika.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1Y7yn8LXFlqvoRciBE9LUoRoeGZFuoZhW
"""
...
def tambah_kontak():
  while True:
    tampilkan_kontak()
    masukkan_nama=str(input('Masukkan Nama: '))
    nama_baru=masukkan_nama.replace(' ','')
    if nama_baru.lower() not in daftar_kontak.keys():
      ...
      jabatan_baru = str(input('Masukkan Jabatan: '))
      telepon_baru = int(input('Masukkan Telepon: '))
      check = str(input(f'Apakah Data yang Anda Masukkan Benar = {NIP_baru},{nama_baru},{departement_baru},{jabatan_baru},{telepon_baru} Yes/No: '))
      if check != 'Yes':
        print ('Daftar Kontak Gagal Dimasukkan')
        break
      else:
        daftar_kontak[masukkan_nama.lower()]={
            'NIP': NIP_baru,
            'Nama': nama_baru,
            'Departement': departement_baru,
            'Jabatan': jabatan_baru,
            'Telepon': telepon_baru
        }
        tampilkan_kontak()
        print('Daftar Kontak Berhasil Dimasukkan')
        break
    else:
    ...
    while True:
        try:
          ...
          daftar_kontak[kontak_baru] = {
                ...
                "No_Telepon": telepon_baru1
            }
          print("Data Tersebut " + nama_baru + "Berhasil Dimasukkan!\n")
          break
        except ValueError:
...
def tampilkan_opsi():
    ...
    print("1. Menampilkan Semua Daftar")
